import {
  ...
  import {
    profileFollowData, profileFollowError, profileFollowersStart, profileFollowersError,
    profileFollowersSuccess, profileFollowingStart, profileFollowingError, profileFollowingSuccess
  } from './actions';
  ...
  describe('Profile action creator', () => {
    ...
    expect(profileFollowersStart({}).type).toEqual(PROFILE_FOLLOWERS_START);
  });
